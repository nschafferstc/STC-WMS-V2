...
export default async function OrderImportAdminPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        ...
        description="Configure field mapping for bulk order uploads and import templates"
      />
      <div className="bg-white rounded-lg border p-8 text-center text-slate-400 text-sm">
        Order import template configuration coming soon.
      </div>
    </div>
  )
}
